...
double *analyze(char **args)
{
    ...
    if (args_count == 10)
    {
        ...
        double y5 = C_y_y5[0] + C_y_y5[1]*(AT/(L*B)) + C_y_y5[2]*pow((HBR/L),-1) + C_y_y5[3]*(CBR/L) + C_y_y5[4]*pow((HC/B),2) + C_y_y5[5]*(CBR/L) + C_y_y5[6]*((L*HC)/AT);
        
        double n1 = C_n_n1[0] + C_n_n1[1]*(CBR/L) + C_n_n1[2]*((L*HC)/AT) + C_n_n1[3]*pow((AT/AL),-1) + C_n_n1[4]*(CBR/HC) + C_n_n1[5]*(AT/(L*B)) + C_n_n1[6]*pow((AOD/L),2) + C_n_n1[7]*pow((pow((AT/L),2)),-1) + C_n_n1[8]*(CBR/L);
        double n2 = C_n_n2[0] + C_n_n2[1]*(CBR/L) + C_n_n2[2]*(C/L) + C_n_n2[3]*pow((AOD/AT),-1) + C_n_n2[4]*pow((HC/B),2) + C_n_n2[5]*pow((HBR/L),-1) + C_n_n2[6]*pow(((B*HBR)/AT),-1) + C_n_n2[7]*(AT/(L*B)) + C_n_n2[8]*pow((HBR/L),2);
